> This foundation is not the same as Foundation on Linux of Windows ([Foundation](../Foundation.md) - framework to work with network, dates etc. stuff in [Swift](../../../Swift.md))
